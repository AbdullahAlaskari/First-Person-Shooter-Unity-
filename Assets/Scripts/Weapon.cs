...
public class Weapon : MonoBehaviour {
	...
	void OnTriggerStay(Collider collider){
		if (collider.transform.tag == "player" && !transform.parent && Input.GetKeyDown (KeyCode.Q)) { //If the player is in range and presses "Q" and has no parent (it can be picked)
